...
main ()
{
  ...
  float employee_ID, age, basic, expi, DA, tax, Final_salary, increment, MA, HRA,
  P_T, I_T, Gross_salary, salary_slip, Net_salary;
  int num;
  char type, dep;
  ...
  if (basic != 0)
    {
      ...
      printf("press '1' for Employee Details \t");
    printf("press '2' for Salary Slip\t");
    scanf("%d", &num);
     switch(num){
     case 1:
  ...
  printf
    (" DA \t %f \n TAX \t %f \n HRA \t %f \n MA \t %f \n I_T \t %f \n P_T \t %f \n GROSS_SALARY \t %f \n FINAL_SALARY \t %f \n NET_SALARY \t %f \n ",
     DA, tax, HRA, MA, P_T, I_T, Gross_salary, Final_salary, Net_salary);
     break;
     }
  return 0;
}
